...
INSERT INTO profiles (id, full_name, email, role) VALUES
    ...
    ('22222222-2222-2222-2222-222222222222', 'Priya Sharma', 'manager@saasum.in', 'manager'),
    ('33333333-3333-3333-3333-333333333333', 'Arjun Mehta', 'rep@saasum.in', 'sales_rep'),
    ('44444444-4444-4444-4444-444444444444', 'Sneha Reddy', 'ambassador@saasum.in', 'ambassador')
ON CONFLICT DO NOTHING;
